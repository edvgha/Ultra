...
{
    test(ir_if_3, {at::ones({2, 2}), true, 10}, {{"Tensor", "at::ones({2, 2})"}, {"bool", "true"}, {"int", "10"}}, "1");
    test(ir_if_3, {at::ones({2, 2}), false, 10}, {{"Tensor", "at::ones({2, 2})"}, {"bool", "false"}, {"int", "10"}}, "2");
    test(ir_if_3, {at::ones({2, 2}), true, -10}, {{"Tensor", "at::ones({2, 2})"}, {"bool", "true"}, {"int", "-10"}}, "3");
    test(ir_if_3, {at::ones({2, 2}), false, 0}, {{"Tensor", "at::ones({2, 2})"}, {"bool", "false"}, {"int", "0"}}, "4");
}
