...
{
    test(ir_if_4, {at::ones({2, 2}), 10.0}, {{"Tensor", "at::ones({2, 2})"}, {"float", "10.0"}}, "1");
    test(ir_if_4, {at::ones({2, 2}), 10.0}, {{"Tensor", "at::ones({2, 2})"}, {"float", "10.0"}}, "2");
    test(ir_if_4, {at::ones({2, 2}), -10.0}, {{"Tensor", "at::ones({2, 2})"}, {"float", "-10.0"}}, "3");
    test(ir_if_4, {at::ones({2, 2}), 0.0}, {{"Tensor", "at::ones({2, 2})"}, {"float", "0.0"}}, "4");
}
