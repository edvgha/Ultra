...
{
    test(ir_if_2, {at::ones({2, 2}), 10}, {{"Tensor", "at::ones({2, 2})"}, {"int", "10"}}, "1");
    test(ir_if_2, {at::ones({2, 2}), -10}, {{"Tensor", "at::ones({2, 2})"}, {"int", "-10"}}, "2");
    test(ir_if_2, {at::ones({2, 2}), 0}, {{"Tensor", "at::ones({2, 2})"}, {"int", "0"}}, "3");
}
